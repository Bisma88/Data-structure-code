...
static ArrayList&lt;Integer&gt; cpuPositions= new ArrayList&lt;Integer&gt;(); //Creating an ArrayList for storing
winning positions of the board for CPU random entries
...
//Creating a function named Placement() which places the symbol(O or X) on the desired position of
game board and also switch between user and CPU turn

public static void Placement(char [][] gameBoard,int pos,String user)
{
//switching between user and CPU turns and also adding the occupied places of board to the ArrayList
to help identify the winner
char symbol=&#39; &#39;;
...
//Creating main function which calls all the ablove functions,creates an empty game board, takes user
...
{&#39; &#39;,&#39;|&#39;,&#39; &#39;,&#39;|&#39;,&#39; &#39;},
{&#39;-&#39;,&#39;+&#39;,&#39;-&#39;,&#39;+&#39;,&#39;-&#39;},
{&#39; &#39;,&#39;|&#39;,&#39; &#39;,&#39;|&#39;,&#39; &#39;}}; //creating a game board from 2D array is copied from a youtubr video
...
while(playerPositions.contains(playerPos)||cpuPositions.contains(playerPos)) //contains method
functionality is copied from a youtube video https://www.youtube.com/watch?v=gQb3dE-y1S4
{
System.out.println(&quot;Place occupied!! choose the correct position.&quot;);
playerPos=scan.nextInt();

}
Placement(gameBoard,playerPos,&quot;Player&quot;); //calling the function to put the symbol of player on
game board according to the input position
...
Placement(gameBoard,CPUpos,&quot;CPU&quot;);//calling the function to put the symbol of CPU on game
board according to the random function position
